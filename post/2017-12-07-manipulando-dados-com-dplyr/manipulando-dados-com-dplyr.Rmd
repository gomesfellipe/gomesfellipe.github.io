...
- r
- tidyverse
description: "Tutorial completo do pacote dplyr para manipulação de dados em R: filtrar, selecionar, agrupar e transformar data frames com o tidyverse."
featuredalt: "Logo do pacote dplyr do tidyverse para manipulação de dados em R"
featured: dplyr.png
featuredpath: date
type: post
image_preview: dplyr.png
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2017/12/dplyr.png
og_type: article
article_section: Programming
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2017/12/dplyr.png
keywords: data-mining, dplyr, estatistica, pratica, r, tidyverse
robots: index, follow
