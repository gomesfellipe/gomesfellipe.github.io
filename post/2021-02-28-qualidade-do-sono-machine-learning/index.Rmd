...
featured: img.jpeg
featuredalt: Ilustração sobre prevendo a qualidade do sono utilizando machine learning
featuredpath: date
type: post
output:
  blogdown::html_page:
...
keywords: imbalanced, imbalanced-data, lightgbm, r, random-forest, threshold-movel,
  tidymodels, tidyverse, tunning, data science, machine learning, analytics
robots: index, follow
