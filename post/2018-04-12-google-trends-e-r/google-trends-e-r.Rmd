...
- rstudio
- series-temporais
description: Utilizando a API do google trends direto no R possibilitando a análise
  de séries temporais
featured: gtrends-r.png
featuredalt: Ilustração sobre séries temporais com google trends e r
featuredpath: date
type: post
...
keywords: google, google-trends, pratica, r, rstudio, series-temporais, data science,
