...
- rstudio
- series-temporais
description: "Como acessar a API do Google Trends em R com o pacote gtrendsR para coletar e analisar séries temporais de buscas populares."
featured: gtrends-r.png
featuredalt: "Gráfico de tendências do Google Trends analisado como série temporal em R"
featuredpath: date
type: post
image_preview: gtrends-r.png
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2018/04/gtrends-r.png
og_type: article
article_section: Artificial Intelligence
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2018/04/gtrends-r.png
keywords: google, google-trends, pratica, r, rstudio, series-temporais
robots: index, follow
