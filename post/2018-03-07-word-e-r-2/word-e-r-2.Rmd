...
- rmarkdown
- word
description: As análises foram feitas em R e agora? Geralmente um bom PDF ou HTML
  são suficientes mas e se o destino da análise tiver que ser um documento Word?
featured: Word-R.png
featuredalt: Ilustração sobre produzindo e formatando um documento word direto em
  r
featuredpath: date
type: post
image_preview: Word-R.png
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2018/03/Word-R.png
og_type: article
article_section: Programming
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2018/03/Word-R.png
keywords: estatistica, gamificacao, macro, pratica, r, rmarkdown, word, data science,
