...
- shap
- threshold-movel
description: Confira a estratégia aplicada para a competição de machine learning do
  Porto Seguro hospedada no Kaggle
featured: img.png
featuredalt: Ilustração sobre solução final  porto seguro data challenge 3º lugar
featuredpath: date
type: post
output:
  blogdown::html_page:
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2021/11/img.png
og_type: article
article_section: Artificial Intelligence
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2021/11/img.png
keywords: catboost, data-science, kaggle, knn, machine-learning, optuna, pratica,
  python, shap, threshold-movel, data science, machine learning, analytics
robots: index, follow
...
knitr::opts_chunk$set(python.reticulate = FALSE, echo = TRUE, eval=F, warning = F, message = F, error = F, 
