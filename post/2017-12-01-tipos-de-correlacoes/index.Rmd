...
- r
- teste-fisher
description: "Aprenda os principais tipos de correlação e associação em R: Pearson, Spearman, Kendall, Qui-quadrado, teste de Fisher, V de Cramer e Kappa com exemplos práticos."
featured: ''
featuredalt: "Matriz de correlação com coeficientes de Pearson, Spearman e Kendall em R"
featuredpath: ''
type: post
output:
  blogdown::html_page:
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/main/logo1.jpg
og_type: article
article_section: Programming
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/main/logo1.jpg
keywords: correlacao, correlacoes, cramer, estatistica, kappa, qui-quadrado, r, teste-fisher
robots: index, follow
