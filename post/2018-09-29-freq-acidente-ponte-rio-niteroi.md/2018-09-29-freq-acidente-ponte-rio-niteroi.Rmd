...
date: '2018-09-29'
slug: freq-acidente-ponte-rio-niteroi
categories:
  - dplyr
  - Estatistica
  - leaflet
...
base %>% 
  ...
  SmartEDA::ExpCatViz(gp=NULL, fname=NULL, margin=2, Page = c(2,2)) 
```
...
<center> ![](/img/2018-09-29-freq-acidente-ponte-rio-niteroi/noticia.png) </center>
...
g2  <- 
  autoplot(fit,which=1:6, print=F,suppressMessages=T) +
  theme_bw()
