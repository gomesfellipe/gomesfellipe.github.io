---
title: Desenvolva um bot e receba resultados de Machine Learning no seu Smartphone
  para ajudar nos investimentos
...
- r
- reports
description: Entenda a lógica de como montar uma carteira, coletar dados de finança
  em tempo real, treinar um modelo de Machine Learning com Prophet (Facebook Open
  Source) e receber análises automatizadas no Smartphone
featured: img.png
featuredalt: Ilustração sobre desenvolva um bot e receba resultados de machine learning
  no seu smartphone para ajudar nos investimentos
featuredpath: date
type: post
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2020/03/img.png
og_type: article
article_section: Artificial Intelligence
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2020/03/img.png
keywords: bitcoin, bolsa-de-valores, correlacao, dplyr, estatistica, machine-learning,
  modelagem, prophet, r, reports, data science, machine learning, analytics
robots: index, follow
...
knitr::opts_chunk$set(eval=F, echo = TRUE, message = F, warning = F, fig.align = "center", fig.width = 10)
```
...
<center>![](/post/2020-03-25-investment-alert/noticia_poupanca.png){width=50%} <br><small>Fonte: <https://noticias.r7.com/economia/economize/poupanca-em-baixa-exige-busca-por-novos-investimentos-em-2020-25122019></small></center></br>
...
<div class="row">
<div class="column4">
<center>![](/post/2020-03-25-investment-alert/watch.png)</center> 
</div> 
<div class="column8"> 
![](/post/2020-03-25-investment-alert/report_stocks.gif){width=90%}
</div> 
</div>
...
<div class="column4">
![](/post/2020-03-25-investment-alert/ovos_mesm_cesta.png){width=90%}
</div> 
</div>
...
<center>
![](/post/2020-03-25-investment-alert/tesouro_direto.png){width=80%}
...
<center>
![](/post/2020-03-25-investment-alert/img1.png){width=80%}
</center>
...
<center>
![](/post/2020-03-25-investment-alert/ds-pipeline.png){width=60%}
</br>
...
<center>
![](/post/2020-03-25-investment-alert/unnamed-chunk-10-1.png){width=80%}
</center>
...
<center>
![](/post/2020-03-25-investment-alert/unnamed-chunk-11-1.png){width=80%}
</center>
...
<div class="column"> 
![](/post/2020-03-25-investment-alert/prophet_logo.png){width=80%}
...
* treino: inicio da série até 18/11/20;
* teste: de 18/11/2020 até o final da série histórica (2 meses atrás)
...
ggsave("prophet.png") # salvar para o bot retornar este resultado!
```

<center>
![](/post/2020-03-25-investment-alert/unnamed-chunk-15-1.png){width=80%}
</center>
...
<center>
![](/post/2020-03-25-investment-alert/img2.png){width=80%}
</center>
...
<center>
![](/post/2020-03-25-investment-alert/img3.png){width=80%}
</center>
...
<center>
![](/post/2020-03-25-investment-alert/img4.png){width=80%}
</center>
...
<center>
![](/post/2020-03-25-investment-alert/img5.png){width=80%}
</center>
...
<center>![](/post/2020-03-25-investment-alert/bot_telegram.png){width=99%}</center>
</div>
</div>
...
<center>![](/post/2020-03-25-investment-alert/report_stocks.gif){width=70%}</center>
</br>
