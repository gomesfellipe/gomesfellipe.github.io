...
- ggplot2
- r
description: "Guia prático para escolher a medida de correlação correta para cada tipo de variável: numérica, categórica e ordinal. Exemplos visuais com ggplot2 em R."
featured: ''
featuredalt: "Gráficos de dispersão mostrando diferentes tipos de relações entre variáveis estatísticas"
featuredpath: ''
type: post
...
keywords: correlacao, correlacoes, ggplot2, r
robots: index, follow
