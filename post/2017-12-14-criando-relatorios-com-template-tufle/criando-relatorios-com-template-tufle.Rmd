---
title: Criando Relatórios com Template Tufte
...
- rstudio
- tufle
description: Além da limpeza da base de dados, análises e aplicação de metodologias
  estatísticas para a solução de problemas, escrever relatórios também é uma tare...
featured: ''
featuredalt: "Exemplo de relatório formatado com o template Tufte em RMarkdown"
featuredpath: ''
type: post
...
keywords: pratica, r, rmarkdown, rstudio, tufle
robots: index, follow
