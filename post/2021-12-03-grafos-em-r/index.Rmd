...
tags:
  ...
  - web scrappnig
  - ggplot
description: 'Neste post vamos coletar notícias via web scrapping, detectar entidades dos textos e criar um grafo utilizando ggplot'
featured: 'img1.png'
featuredalt: 'Pic 28'
featuredpath: 'date'
linktitle: ''
...
Os dados utilizados neste post foram coletados via web screpping do site do [G1 - Globo](https://g1.globo.com/). Optei por trabalhar com textos jornalisticos neste post pois apresentam a vantagem de serem bem escritos, o que facilita na tarefa de mineração de texto.
...
Finalmente, vamos criar o grafo utilizando `ggplot`:
