...
- r
- regressao
description: Um pouco sobre as duas grandes escolas de inferência, contas e implementação
  de um modelo linear bayesiano na mão para dados simulados e para dados reais
featured: img1.png
featuredalt: "Comparação entre ajuste de modelo linear clássico e bayesiano com distribuições a posteriori"
featuredpath: date
type: post
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2018/07/img1.png
og_type: article
article_section: Artificial Intelligence
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2018/07/img1.png
keywords: bayes, estatistica, jags, modelagem, modelagem-estatistica, modelos-generalizados,
  modelos-lineares, probabilidade, r, regressao
robots: index, follow
