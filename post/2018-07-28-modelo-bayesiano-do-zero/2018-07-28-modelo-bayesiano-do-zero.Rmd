---
title: Ajustando um modelo de regressão linear bayesiano do zero
author: Fellipe Gomes
bibliography: ref.bib
date: '2018-07-28'
slug: modelo-bayesiano-do-zero
categories:
  - bayesiana
  - Estatistica
  - Modelos
...
suppressMessages(
  devtools::source_url(
    "https://raw.githubusercontent.com/gomesfellipe/projeto_modelos_hierarquicos_bayesianos/master/dependencies.R",
    encoding="UTF-8"
  )
)
```
...
```{r}
coef <-
  coeficientes(results, real = real) %>% as.data.frame()
