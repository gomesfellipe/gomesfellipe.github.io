...
- simulacao
- teoria
description: Quanto você acha que é a probabiliddade num grupo de 23 pessoas escolhidas
  aleatoriamente que duas delas farão aniversário no mesmo dia? Acreditaria se eu
  te dissesse que essa chance é maior do que 50%? A probabilidade é contra intuitiva
  e neste post vamos demonstrar de forma analitica e atraves de simulação esse e outros
  resultados além de dissertar um pouco sobre a história e conceitos importantes de
  probabilidade
featured: modelagem-probabilidade2.png
featuredalt: Ilustração sobre o paradoxo dos aniversários com simulação e probabilidade
featuredpath: date
references:
- id: DeGroot
...
- id: Feller
  ...
  type: book
type: post
image_preview: modelagem-probabilidade2.png
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2018/01/modelagem-probabilidade2.png
og_type: article
article_section: Artificial Intelligence
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2018/01/modelagem-probabilidade2.png
keywords: analise-multivariada, estatistica, modelagem, modelagem-estatistica, probabilidade,
  simulacao, teoria, data science, machine learning, analytics
robots: index, follow
