...
- r
- rstudio
description: 'Carnaval esta começando e muita gente quer saber: "Onde tem bloco??"
  Para ajudar a responder essa pergunta e orientar os foliões hoje vou mostrar como
  podemos obter referencias geograficas a partir de endereços e criar mapas interativos
  usando R!'
featured: carnaval2.png
featuredalt: "Mapa interativo do Rio de Janeiro com localização de blocos de carnaval feito com Leaflet em R"
featuredpath: date
type: post
image_preview: carnaval2.png
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2018/02/carnaval2.png
og_type: article
article_section: Artificial Intelligence
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2018/02/carnaval2.png
keywords: estatistica, google, leaflet, mapa, pratica, r, rstudio
robots: index, follow
