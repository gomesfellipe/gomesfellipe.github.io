...
- series-temporais
- servidor
description: Uma maneira prática de hospedar o app desenvolvido no post no Shiny Server
  e ter seu próprio RStudio Server na nuvem do Google em uma máquina virtual Ubuntu
  16.04.
featured: img1.png
featuredalt: Ilustração sobre seu app rstudio e shiny server na nuvem do google
featuredpath: date
type: post
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2018/10/img1.png
og_type: article
article_section: Artificial Intelligence
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2018/10/img1.png
keywords: bitcoin, estatistica, google, google-cloud, pratica, r, rstudio, rstudio-server,
  series-temporais, servidor, data science, machine learning, analytics
robots: index, follow
