...
featured: img.png
featuredalt: Ilustração sobre análise de sentimentos com um chatgpt de código aberto
featuredpath: date
type: post
output:
  blogdown::html_page:
...
keywords: chatgpt, data-science, gam, inteligencia-artificial, llama2, llm, python,
  redes-neurais, sentiment-analysis, data science, machine learning, analytics
robots: index, follow
