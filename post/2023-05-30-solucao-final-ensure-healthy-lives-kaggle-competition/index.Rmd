...
- pratica
- r
description: "Solução vencedora (1º lugar) da ML Olympiad do Kaggle: estratégia analítica completa com CatBoost e R para classificação em dados de saúde pública."
featured: img.png
featuredalt: "Resultado do 1º lugar na ML Olympiad do Kaggle com modelo de classificação CatBoost"
featuredpath: date
type: post
output:
  blogdown::html_page:
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2023/05/img.png
og_type: article
article_section: Artificial Intelligence
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2023/05/img.png
keywords: catboost, classification, data-mining, data-science, kaggle, machine-learning,
  modelagem, pratica, r
robots: index, follow
...
knitr::opts_chunk$set(python.reticulate = FALSE, echo = TRUE, eval = T, warning = F, error = F, message = F)
```
