---
title: Um estudo sobre modelos de aprendizagem baseados em árvores com desafio do
  Kaggle
...
- pratica
- r
description: Um estudo aplicado de modelos de aprendizagem baseados em árvores utilizando
  a base de dados do Kaggle para prever o preço final de casas residenciais em Ames,
  Iowa, utilizando uma variedade de aspectos
featured: img1.png
featuredalt: Ilustração sobre um estudo sobre modelos de aprendizagem baseados em
  árvores com desafio do kaggle
featuredpath: date
type: post
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2018/08/img1.png
og_type: article
article_section: Artificial Intelligence
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2018/08/img1.png
keywords: caret, correlacao, data-mining, decisiontree, estatistica, kaggle, modelagem,
  modelagem-estatistica, pratica, r, data science, machine learning, analytics
robots: index, follow
