...
- rstudio
- shiny
description: Este post traz uma retrospectiva do que aconteceu por aqui em 1 ano de
  blog, foi muito empolgante o término do desafio que fiz a mim mesmo e a animação
  para novos desafios continua!
featured: img1.png
featuredalt: Ilustração sobre um ano de blog
featuredpath: date
type: post
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2018/12/img1.png
og_type: article
article_section: Programming
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2018/12/img1.png
keywords: estatistica, kaggle, machine-learning, retrospectiva, rmarkdown, rstudio,
  shiny, data science, machine learning, analytics
robots: index, follow
