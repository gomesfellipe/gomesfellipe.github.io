...
- rmarkdown
- teoria
description: '[Imagem do Wikpedia](https://commons.wikimedia.org/wiki/File:Multivariate_Gaussian.png)'
featured: multivariada-fatorial-cluster-R.png
featuredalt: Ilustração sobre análise multivariada com r
featuredpath: date
type: post
...
keywords: analise-multivariada, clustering, estatistica, kmeans, pca, r, rmarkdown,
  teoria, data science, machine learning, analytics
robots: index, follow
