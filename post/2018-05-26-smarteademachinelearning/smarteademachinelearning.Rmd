...
- r
- rstudio
description: Veja como é possível realizar a AED de forma muito rápida com o pacote
  SmartEAD, além de uma breve aplicação de técnicas de machine learning e estatística
  para ilustrar alguns possíveis cenários da analise da dados
featured: img1.png
featuredalt: Ilustração sobre aed de forma rápida e um pouco de machine learning
featuredpath: date
type: post
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2018/05/img1.png
og_type: article
article_section: Artificial Intelligence
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2018/05/img1.png
keywords: analise-multivariada, correlacao, data-mining, estatistica, kmeans, modelagem,
  pca, r, rstudio, data science, machine learning, analytics
robots: index, follow
