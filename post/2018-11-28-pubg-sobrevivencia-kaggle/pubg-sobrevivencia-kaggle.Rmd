...
- r
- survivor
description: O que interefere na probabilidade de um indivíduo sobreviver? Quais fatores
  apresentam efeito no risco de morte em um intervalo de tempo? Neste post buscaremos
  evidências estatísticas para responder estas perguntas em dados abertos do PUBG
  hospedados no Kaggle
featured: img.png
featuredalt: Ilustração sobre análise de sobrevivência com dados do jogo pubg disponíveis
  no kaggle
featuredpath: date
type: post
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2018/11/img.png
og_type: article
article_section: Artificial Intelligence
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2018/11/img.png
keywords: analise-de-sobrevivencia, data-mining, estatistica, gamificacao, gamification,
  kaggle, modelagem, modelagem-estatistica, r, survivor, data science, machine learning,
  analytics
robots: index, follow
...
# Opcoes do RMarkdown
knitr::opts_chunk$set(eval=F, echo = TRUE, warning = F, message = F, fig.height = 5)
```
...
![](/post/2018-11-28-pubg-sobrevivencia-kaggle/pubg-sobrevivencia-kaggle_files/unnamed-chunk-4-1.png){width=80%}
...
![](/post/2018-11-28-pubg-sobrevivencia-kaggle/pubg-sobrevivencia-kaggle_files/unnamed-chunk-6-1.png){width=80%}
...
![](/post/2018-11-28-pubg-sobrevivencia-kaggle/pubg-sobrevivencia-kaggle_files/unnamed-chunk-7-1.png){width=80%}
...
![](/post/2018-11-28-pubg-sobrevivencia-kaggle/pubg-sobrevivencia-kaggle_files/unnamed-chunk-9-1.png){width=80%}
...
![](/post/2018-11-28-pubg-sobrevivencia-kaggle/pubg-sobrevivencia-kaggle_files/unnamed-chunk-11-1.png){width=80%}
...
![](/post/2018-11-28-pubg-sobrevivencia-kaggle/pubg-sobrevivencia-kaggle_files/unnamed-chunk-13-1.png){width=80%}
...
![](/post/2018-11-28-pubg-sobrevivencia-kaggle/pubg-sobrevivencia-kaggle_files/unnamed-chunk-17-1.png){width=80%}
...
![](/post/2018-11-28-pubg-sobrevivencia-kaggle/pubg-sobrevivencia-kaggle_files/unnamed-chunk-18-1.png){width=80%}
...
![](/post/2018-11-28-pubg-sobrevivencia-kaggle/pubg-sobrevivencia-kaggle_files/unnamed-chunk-22-1.png){width=80%}
...
![](/post/2018-11-28-pubg-sobrevivencia-kaggle/pubg-sobrevivencia-kaggle_files/unnamed-chunk-23-1.png){width=80%}
