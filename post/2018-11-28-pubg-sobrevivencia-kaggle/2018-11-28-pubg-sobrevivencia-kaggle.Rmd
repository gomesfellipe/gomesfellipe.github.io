...
date: '2018-11-28'
slug: pubg-sobrevivencia-kaggle
categories:
  - dplyr
  - Estatistica
  - gamificacao
...
# Opcoes do RMarkdown
knitr::opts_chunk$set(echo = TRUE, warning = F, fig.height = 7, fig.width = 10)
```
...
![](/img/2018-11-28-pubg-sobrevivencia-kaggle/img.png)
...
```{r}
# Carregar pacotes --------------------------------------------------------
packages <- c("data.table", "dplyr", "purrr", "survival"  , "survminer","ggfortify","GGally", "ggplot2","moments", "gridExtra","ggExtra", "cowplot","lubridate", "scales", "knitr", "kableExtra", "grid","broom", "formattable", "grid")
...
<iframe src="https://giphy.com/embed/o5hGnFgcKTiHC" width="100%" height="210" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
...
<iframe src="https://giphy.com/embed/RHJkLqcdvMQF4GI3P7" width="100%" height="270" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
