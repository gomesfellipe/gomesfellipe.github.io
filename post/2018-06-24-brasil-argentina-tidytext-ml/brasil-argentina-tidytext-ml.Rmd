...
- text-mining
- twitter
description: Aplicando técnincas de Text Mining como pacote tidy text para explorar
  a rivalidade entre Brasil e Argentina! Veja também como a análise de sentimentos
  pode ser divertida além de possíveis aplicações de machine learning
featured: img1.jpeg
featuredalt: "Nuvem de palavras e análise de sentimentos sobre Brasil x Argentina com tidytext"
featuredpath: date
references:
- id: miner
...
- Code Example
- Case Study
og_image: https://gomesfellipe.github.io/img/2018/06/img1.jpeg
og_type: article
article_section: Artificial Intelligence
twitter_card: summary_large_image
twitter_image: https://gomesfellipe.github.io/img/2018/06/img1.jpeg
keywords: data-mining, estatistica, modelagem, pratica, r, text-mining, twitter, data
  science, machine learning, analytics
robots: index, follow
